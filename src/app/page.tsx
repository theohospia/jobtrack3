          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center gap-10">
              ...
              <nav className="flex items-center gap-8">
                <Link href="/" className="text-[#4f5dd3] font-medium">
                  Listings
                </Link>
                <Link href="/deals" className="text-gray-600 hover:text-[#252553] font-medium">
                  My deals
                </Link>
                <Link href="/messages" className="text-gray-600 hover:text-[#252553] font-medium">
                  Inbox
                </Link>
              </nav>
            </div>
